...
The project includes a custom management command that populates the database with Harry Potter themed wizards, categories, listings, and pre-populates them with some random bids and comments.
...
* **harry** – harry@hogwarts.edu
* **ron** – ron@hogwarts.edu
* **hermione** – hermione@hogwarts.edu
* **malfoy** – malfoy@hogwarts.edu
